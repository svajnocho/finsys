...
if ( ! class_exists( 'TM_Renovation_Templates' ) ) {
	...
	class TM_Renovation_Templates {
		...
		public static function testimonials_item_template() {
			return '<div id="quote-%%ID%%" class="%%CLASS%%" itemprop="review" itemscope itemtype="http://schema.org/Review"><blockquote class="testimonials-text" itemprop="reviewBody">%%TEXT%%</blockquote><div class="item-info">%%AVATAR%% %%AUTHOR%%</div></div>';
		}
	}
